...
bar counts down the last hour: yellow at 23:00, orange at 23:30, red and faster
from 23:40, a panic strobe for the last five minutes. The week turns pink and
never blinks.
...
`tests/run-tests` (720 of them, about fifty seconds; pytest args pass through).
